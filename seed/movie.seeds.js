...
const Movie = require("../models/movie.model"); // attention à ne pas oublier require


const MONGO_URI = process.env.MONGO_URI || "mongodb://localhost/library-project";
...
.catch(err => console.log(`An error occurred while creating movie from the DB: ${err}`)); 